package com.example.exchangerateapi.presentation.view;
...
import com.example.exchangerateapi.domain.viewmodel.MainViewModel;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickConvertReverse(View view){
        String currencyTo;
        String currencyRes;
        if (checkConnection(getApplication().getApplicationContext())) {
            currencyRes = binding.SpinnerConvertTo.getSelectedItem().toString();
            currencyTo = binding.SpinnerConvertRes.getSelectedItem().toString();
            mainViewModel.getValue(currencyRes, currencyTo).observe(this,
                    conversionRate -> {
                        double result;
                        result = Double.parseDouble(binding.EtConvertTo.getText().toString())
                                * conversionRate;
            ...
            currencyRes = binding.SpinnerConvertTo.getSelectedItem().toString();
            currencyTo = binding.SpinnerConvertRes.getSelectedItem().toString();
            mainViewModel.getValueFromDb(currencyRes, currencyTo).observe(this,
                    conversionRate -> {
                        double result;
                        result = Double.parseDouble(binding.EtConvertTo.getText().toString())
                                * conversionRate;
